    ...
    <Link to="/login" className="bg-gray-900 hover:bg-gray-700 text-white px-4 py-2 rounded-lg text-sm font-semibold ">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 w-full max-w-5xl">
          <Link
            to="/chat"
            className="bg-gray-800 p-6 rounded-xl flex flex-col items-center shadow-lg hover:bg-gray-700 transition w-full"
          >
        ...
        <div className="mt-12">
          <Link
            to="/tareas"
            className="bg-yellow-400 text-gray-900 px-8 py-4 rounded-full font-semibold text-xl shadow-lg hover:scale-105 transition"
          >
            Ver Tareas 🚀
          </Link>
        </div>
